...
export class DatabaseService {
  ...
  public async testConnection(
    ...
    await this.withResolvedCredentials(
      connection,
      (adapter, credentials) => adapter.testConnection(connection, credentials),
      false,
      passwordOverride,
    );
  }
  ...
  public async discoverDatabases(
    ...
    return this.withResolvedCredentials(
      connection,
      (adapter, credentials) =>
  ...
  public async previewTable(
    ...
    return this.executeQuery(
      connection,
      buildPreviewTableSql(connection.engine, table),
      passwordOverride,
    );
  }
    ...
    try {
      ...
      if (
        ...
        this.errorReporter?.warn(
          "Authentication failed. Invalidating cached AWS secret and retrying once.",
          {
