...
import App from './App';
import { dispatchIncomingMessage, installMockVsCodeApi } from './test-utils/mockVsCode';
...
describe('workbench view', () => {
  ...
  test('sends a saveConnection message when saving a draft', async () => {
    ...
    await userEvent.type(screen.getByPlaceholderText('Enter password'), 'secret-password');
